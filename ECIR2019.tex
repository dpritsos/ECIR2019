...
\hline
\end{tabular}
\caption {Maximum performance of NNDR on Distributional Features of SANTINIS coprus}
...
F1 & 0.7 & 0.3 & 0.8 & 0.2 or 0.5 & W3G & 5000 & 0.681 & 0.378 & 0.488 & 0.673 \\
AUC & 0.5 & 0.5 & 0.6 & 0.5 & W3G & 5000 & 0.738 & 0.604 & 0.473 & 0.664 \\
\hline
\end{tabular}
\caption {Maximum performance of NNDR on TF Features of SANTINIS coprus}
\label{tbl:NNDR_TF}
\end{table}
...
\hline
\end{tabular}
\caption {Maximum performance of RFSE on TF Features of SANTINIS coprus}
\label{tbl:RFSE_TF}
\end{table}
